            ...
            <div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
	            ...
	            <p class="field-custom description description-wide">
	                <label for="edit-menu-item-is-mega-submenu-title-<?php echo $item_id; ?>">
	                    ...
	                    <input type="checkbox" id="edit-menu-item-is-mega-submenu-title-<?php echo $item_id; ?>" class="widefat code edit-menu-item-custom" name="menu-item-is-mega-submenu-title[<?php echo $item_id; ?>]" value="<?php echo esc_attr( $item->is_mega_submenu_title ); ?>" />
	                </label>
	            </p>
                <p class="field-custom description description-wide">
                ...
                <p class="field-custom description description-wide">
	                <label for="edit-menu-item-mega-menu-description-<?php echo $item_id; ?>">
	                    ...
	                    <textarea id="edit-menu-item-mega-menu-description-<?php echo $item_id; ?>" class="widefat code edit-menu-item-custom" name="menu-item-mega-menu-description[<?php echo $item_id; ?>]" value="<?php echo esc_attr( $item->mega_menu_description ); ?>" ></textarea>
	                </label>
	            </p>
	            <?php
